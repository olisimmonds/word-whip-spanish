...
### Remaining Tasks
- [ ] TEST-1: Add Vitest and data integrity tests
- [ ] TEST-2: Unit tests for word selection logic
- [ ] POLISH-1: Update README.md word counts (now 168 nouns, 223 verbs, 50 other words)
- [ ] POLISH-2: Clean up App.css
- [ ] UI-4: Consider adding word category label on card (noun/verb/other)
